            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <button class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                    ...
                    <div class="ml-3 relative" x-data="{ open:false }">
                        ...
                        <div x-show="open" x-on:click.away="open=false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                            ...
                            {{-- Can: directiva de blade que se encarga para verificar si tenemos o no un permiso --}}
                            @can('admin.home')
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Registrese</a>
                    @endif
...
{{-- Buenas tardes, puedo desarrollarlo usando laravel (framework php) bootstrap (plantilla adminlte), es lo más profesional que conseguirás en desarrollo para esa aplicación por el precio ofertado, debo analizar bien cada punto para devolverte feedback con algunas dudas, pero primero debo ver si te interesa trabajar conmigo, mira mi reputación ante todo, saludos.


Hola soy Jose Marin, trabajo el diseño, desarrollo y programación de aplicaciones web y demás programas o sistemas para páginas web. He leído completo su requerimiento y estoy en la capacidad de ayudarlo a desarrollar el proyecto allí descrito. Puedo crear un sistema fácil de manejar para el usuario, me encargo de entregar el programa funcional como también sus respectivos manuales y soporte.
Si estas interesado podemos conversar para que me suministre más detalles, establecer el valor del proyecto y el tiempo de duracion, le garantizo trabajos de calidad y en el tiempo acordado


Que tal buen día. Dispuesto a desarrollar su requerimiento usando como tecnología de desarrollo PHP y Laravel. Contacteme para establecer acuerdos y empezar con el proyecto.

Buscando nuevas oportunidades para demostrar mis habilidades en el desarrollo de aplicaciones web con un gran interés en proyectos que requieren pensamiento conceptual y analítico. Totalmente comprometido con el diseño y desarrollo de materiales innovadores que encantarán a los usuarios. Siempre dispuesto a aprender más y contribuir en lo proyectos. --}}
